...
public class PivotalPostProjectRequestTest {
    ...
    public void postProjectTest() {
        ...
        Response responseProject = RestAssured.given().headers(headers).body(body).when().post(endpoint);
        ...
        File jsonSchemaFile = new File("src/test/resources/schemas/projectSchema.json");
        ...
        String expectedName = "AutomationProject 2";
        Assert.assertEquals(actualName, expectedName);

        // Get ID for deleting.
        idToDelete = responseProject.jsonPath().getString("id");
    }

    @AfterTest
    public void deleteProjectPostCondition() {
        // Define headers using map data structure.
        Map<String, String> headers = new HashMap<>();
        headers.put("X-TrackerToken", "");
        headers.put("Content-Type", "application/json");
        ...
        // Define endpoint.
        String endpoint = "https://www.pivotaltracker.com/services/v5/projects/" + idToDelete;
